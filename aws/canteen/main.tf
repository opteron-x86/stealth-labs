...
module "iam_workshop_user" {
  source = "../modules/iam_workshop_user"
...
module "notebook_instance" {
  ...
  notebook_instance_role_arn = module.notebook_instance_role.notebook_instance_role_arn
  notebook_instance_name     = var.notebook_instance_name
}

module "notebook_instance_role" {
  source = "../modules/notebook_instance_role"
